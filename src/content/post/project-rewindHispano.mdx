...
media: 
  ...
  - path: /Breackdown5.mp4
    caption: Shot with backround and brands removed, ready for composition.
    delay: 0.25
    frame: false
...
PostNextProject:
  ...
  nextUrl: project-hotelbenetusser        
---
